...
//Note: Need to shuffle qusions
        ...
        for(let q of quiz['results']){
            ...
            q.difficulty == 'easy'? easy.push(dic): q.difficulty == 'medium'? medium.push(dic):hard.push(dic);
        }
...
function levelCompletePopup(){
    ...
    let text= document.createTextNode('You\'ve Finshed this level , Go Forward..')
...
addEventListener('click', (e)=>{
    if (e.target.getAttribute('class') === 'diff-sel' && e.target.selectedIndex !== currentCategory){
